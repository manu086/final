...
public class PlanillaController implements Serializable {
    ...
    @EJB
    private org.rrhh.procesos.PlanillaFacade ejbFacade;
    ...
    public DataModel<Planilla> getListaPlanilla(){
        listaPlanilla = new ListDataModel<>(planillaFacade.getListaPlanilla());
        return listaPlanilla;
    }
    
    public double getDatoAfpPlanilla(){
        double datoAfp = planillaFacade.datoAfpPlanilla();
        return datoAfp;
    }
    
    public double getDatoIsssPlanilla(){
        double datoAfp = planillaFacade.datoIsssPlanilla();
        return datoAfp;
    }
    
    public double getDatoRentaPlanilla(){
        double datoAfp = planillaFacade.datoRentaPlanilla();
        return datoAfp;
    }
